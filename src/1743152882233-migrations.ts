...
export class Migrations1743152882233 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "timestamp" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" DROP CONSTRAINT "PK_9d0b2ba74336710fd31154738a5"`,
    );
    await queryRunner.query(`ALTER TABLE "chat" DROP COLUMN "id"`);
    await queryRunner.query(`ALTER TABLE "chat" ADD "id" SERIAL NOT NULL`);
    await queryRunner.query(
      `ALTER TABLE "chat" ADD CONSTRAINT "PK_9d0b2ba74336710fd31154738a5" PRIMARY KEY ("id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" ALTER COLUMN "receiver" DROP NOT NULL`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "chat" ALTER COLUMN "receiver" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" DROP CONSTRAINT "PK_9d0b2ba74336710fd31154738a5"`,
    );
    await queryRunner.query(`ALTER TABLE "chat" DROP COLUMN "id"`);
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" ADD CONSTRAINT "PK_9d0b2ba74336710fd31154738a5" PRIMARY KEY ("id")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "is_read" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "chat" character varying NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "chat" ADD "deleted_at" TIMESTAMP`);
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "chat" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`,
    );
  }
}
